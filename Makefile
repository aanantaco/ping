...
INTERNAL_BUILD_ID	:= $(shell [ -z "${GITHUB_BUILD_NUMBER}" ] && echo "0" || echo ${GITHUB_BUILD_NUMBER})
PWD			        := $(shell pwd)
...
check-APP: ## Check that the $APP ENV variable is set. Needed for golang commands
ifndef APP
